...
class GPT(nn.Module):
    ...
    def _run_block(self, block: Block, i: int, x_attn: Tensor, x_mlp: Tensor, x0: Tensor, input_ids: Tensor, ve_cache: dict, v0: Tensor | None, up_w: Tensor | None = None, down_w: Tensor | None = None):
        n = self.num_layers
        if up_w is None:
    ...
    def _run_layers(self, input_ids: Tensor) -> Tensor:
        ...
        for i in range(self.num_encoder_layers):
            ...
            if i in self.recur_layer_ids:
                ...
                x_attn, x_mlp, _ = self._run_block(self.blocks[i], i, x_attn, x_mlp, x0, input_ids, ve_cache, v0, up_w=up_w, down_w=down_w)
            skips.append(x_attn)
        for i in range(self.num_decoder_layers):
            ...
            if bi in self.recur_layer_ids:
                ...
                x_attn, x_mlp, _ = self._run_block(self.blocks[bi], bi, x_attn, x_mlp, x0, input_ids, ve_cache, v0, up_w=up_w, down_w=down_w)
